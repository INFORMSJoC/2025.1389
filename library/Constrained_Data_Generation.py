...
instancesize_list = [1000]
targetsize_list = [5]
n_features_list = [6]
seed_list = [i for i in range(3)]
noisestd = 0.1
params = list(itertools.product(instancesize_list, targetsize_list,seed_list,n_features_list))

for instancesize, targetsize, s, featuresize in params:
    ...
    df.to_csv(f'{parent_dir}/data/synthetic_manifold_noisy_df_size_{instancesize}_targets_{targetsize}_features_{featuresize}_seed_{s}.csv', index=False)
    df_noisefree.to_csv(f'{parent_dir}/data/synthetic_manifold_noisefree_df_size_{instancesize}_targets_{targetsize}_features_{featuresize}_seed_{s}.csv', index=False)
